<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustDashboard.aspx.cs" Inherits="saisamarthsportscenter.Search.CustDashboard" %>
   ...
   <div class="container">
    ...
    <table class="style1">
        ...
        <asp:HyperLink ID="HyperLink1" runat="server" 
            NavigateUrl="~/Search/SearchProduct.aspx" Font-Bold="True" Font-Size="18pt">Search</asp:HyperLink>
        ...
        <tr>
            <td class="style8">
                <asp:HyperLink ID="HyperLink2" runat="server" 
                    NavigateUrl="~/Search/Searchbycat.aspx" Font-Bold="True" Font-Size="18pt" >Search By Category</asp:HyperLink>
            </td>
            <td>
                &nbsp;</td>
        </tr>
