...
{
    public partial class frm_ProductwiseSaleDetails : System.Web.UI.Page
    {
        SqlConnection cn;
        SqlCommand cmd;
        SqlDataReader dr;
        ...
        public void setdropdown2()
        {
            ...
            DropDownList1.DataTextField = "prod_id";
        ...
        protected void btn_show_Click(object sender, EventArgs e)
        {
            ...
            CrystalReportViewer1.SelectionFormula = "{Sale_details.prod_id}=" + DropDownList1.SelectedValue + "";
