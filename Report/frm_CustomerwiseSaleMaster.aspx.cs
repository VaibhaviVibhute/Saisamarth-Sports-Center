...
{
    public partial class frm_CustomerwiseSaleMaster : System.Web.UI.Page
    {
        SqlConnection cn;
        SqlCommand cmd;
        SqlDataReader dr;
        ...
        protected void btn_show_Click(object sender, EventArgs e)
        {
            ...
            CrystalReportViewer1.SelectionFormula = "{Sale_master.cust_id}=" + DropDownList1.SelectedValue + "";
