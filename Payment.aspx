<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="saisamarthsportscenter.Payment" %>
...
function formValidator()
{
	...
	var Amount = document.getElementById("txt_pay_amt");
        ...
        <table class="table">
            <tr>
                <td class="style5">
                    ...
                    <asp:TextBox ID="txt_pay_id" class="form-control" runat="server" 
            ...
            <tr>
                <td class="style5">
                    ...
                    <asp:TextBox ID="txt_pay_date" class="form-control" runat="server" 
                        Enabled="False" Width="260px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="style5">
                    ...
                    <asp:TextBox ID="TextBox1" class="form-control" runat="server" Enabled="False" 
                        Width="261px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="style5">
                    <asp:Label ID="Label4" runat="server" Text="Payment Amount"></asp:Label>

                    <asp:TextBox ID="txt_pay_amt" class="form-control" runat="server" 
                        Enabled="False" Width="260px"></asp:TextBox>
                </td>
            </tr>
